...
@Component({
  selector: 'app-mapas-campeoes',
  templateUrl: './mapas-campeoes.component.html',
  styleUrls: ['./mapas-campeoes.component.css']
})
export class MapasCampeoesComponent implements OnInit {
	...
	maiorValor: number;
  	...
  	obterSelecoesCampeas(): void {
  		this.graficoService.listarBandeiraSelecoesCampeas().subscribe(
	  		data => {
	  			this.dadosSel = data;
	  			this.getMaiorValor();
	  			this.geraMapa();
  	...
  	geraMapa(): void {
		...
		let chart = am4core.create("geo_chart_campeoes", am4maps.MapChart);
